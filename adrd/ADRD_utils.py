...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=r'D:\adrd-main\adrd-main\adrd\datasets\raodong/train1',
    ...
    parser.add_argument(
        ...
        "--input_dir_path",
        type=str,
        default=r'D:\adrd-main\adrd-main\adrd\datasets\train-1',
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default=r"D:\adrd-main\adrd-main\adrd\data\ckpt\train2.pt",
        help=("Path to save the final data."
        ),
    )
